...
import com.edgar_avc.morena.views.administrador.fragments.Tab2Fragment;
import com.edgar_avc.morena.views.administrador.fragments.HomeFragment;
            ...
            public void onTabSelected(int tabId)
            {
                switch (tabId)
                {
                    ...
                    case R.id.Tab2:
                        ...
                        getSupportFragmentManager().beginTransaction().replace(R.id.containerPrincipal, tab2Fragment)
                                .setTransition(FragmentTransaction.TRANSIT_FRAGMENT_FADE)
                                .addToBackStack(null).commit();
                        break;
